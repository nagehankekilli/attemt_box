...
class SuggestionsControllerTest < ActionController::TestCase
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post :create, suggestion: { date: @suggestion.date, description: @suggestion.description, title: @suggestion.title }
    end
  ...
  test "should update suggestion" do
    patch :update, id: @suggestion, suggestion: { date: @suggestion.date, description: @suggestion.description, title: @suggestion.title }
    assert_redirected_to suggestion_path(assigns(:suggestion))
  end
