...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { date: @complaint.date, description: @complaint.description, title: @complaint.title }
    end
  ...
  test "should update complaint" do
    patch :update, id: @complaint, complaint: { date: @complaint.date, description: @complaint.description, title: @complaint.title }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
